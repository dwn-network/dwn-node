...
module.exports = {
  ...
  port: process.env.DWN_API_PORT || 4003,
  cache: {
    /**
     ...
     */
    generateTimeout: process.env.DWN_API_CACHE_TIMEOUT || 8000,
  },
  // @see https://hapijs.com/api#-serveroptionstls
  ssl: {
    enabled: process.env.DWN_API_SSL,
    host: process.env.DWN_API_SSL_HOST || '0.0.0.0',
    port: process.env.DWN_API_SSL_PORT || 8443,
    key: process.env.DWN_API_SSL_KEY,
    cert: process.env.DWN_API_SSL_CERT,
  },
  ...
  rateLimit: {
    enabled: !process.env.DWN_API_RATE_LIMIT,
    pathLimit: false,
    userLimit: process.env.DWN_API_RATE_LIMIT_USER_LIMIT || 300,
    userCache: {
      expiresIn: process.env.DWN_API_RATE_LIMIT_USER_EXPIRES || 60000,
    },
