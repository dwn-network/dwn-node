...
} = require('../constants').CONFIGURATIONS.DWN.MAINNET

/**
 * TODO copy some parts to DwnDocs
...
module.exports = class Transaction {
  ...
  static serialize(transaction) {
    ...
    bb.writeByte(transaction.network || configManager.get('pubKeyHash')) // dwn = 0x17, devnet = 0x30
